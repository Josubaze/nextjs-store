...
export const Descrition = () =>  {
    ...
    return (
        <section className={styles.Description}>
            <button onClick={handlerClick} className={buttonStyles}>
            ...
            <div className={styles.Description__text}>
                ...
                <p>Future World: Your Gateway to Tomorrow Tech! Dive into a world of cutting-edge gadgets and gear. Stay ahead of the curve and redefine your digital lifestyle with us.</p>
            </div>
        </section>
    )
}